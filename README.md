got it—here’s a careful, end-to-end read of your leaflet.

# What this PDF is

A single-page promotional leaflet for **SEWAS CITY**, attributed to **SEWAS Federation & All Indian Group of Companies**, with the tagline “THE JAINISM OF UNIVERSE.” It prominently names **Project Founder & CMD: Mr. Ashwin R. Shah**. The page mixes Gujarati and English, packs in claims, unit info, financing lines, and a very long list of locations (districts) across India.&#x20;

# Key claims & hard facts (from the leaflet)

* **Unit types & sizes**
  Repeats two typologies: **2 BHK – 540** (sq. ft implied) and **3 BHK – 720** (sq. ft implied). The leaflet also sketches a community math: **32 homes per “unit/zone,” 8 such zones = 256 homes; 4 of these = 1,024 homes.**&#x20;

* **Scale & footprint**
  The page asserts **“800 SEWAS City”** and lists districts across *every* Indian state—e.g., Andhra Pradesh, Gujarat, Odisha, Rajasthan, Tamil Nadu, Telangana, Uttar Pradesh, West Bengal, etc. The lists are exhaustive district enumerations, suggesting presence/ambition nationwide.  &#x20;

* **Longevity / awards / deadline**
  It touts **“29 years”**, **“7 awards,”** and references **“800”** again, alongside a membership/offer cutoff noted as **31-12-2025** in one block. Elsewhere it references **31-12-2030** in connection with a 24–30 month note (see “Financing” below), creating timeline ambiguity. &#x20;

* **Financing & payment lines (fragmented/ambiguous in the leaflet text)**
  The page contains punch lines such as **“0% … 100% …”**, **“60/120/240 months”** (suggesting installment tenors up to 20 years), and a bold claim of **“M.R.P. … 50% …”** without concrete price numbers or conditions. There are also references to **“24 to 30 months”** and the date **31-12-2030**, but context is unclear (possession? scheme validity? completion?).  &#x20;

* **Contact details**
  Shows **[jinfo@sewas.city](mailto:jinfo@sewas.city)**, **[www.sewas.city](http://www.sewas.city)**, and **+91-6359956119**.&#x20;

# What’s strong

* **Simple product definition** (2BHK/3BHK with crisp headline sizes).&#x20;
* **Big ambition / footprint**—the district lists signal scale and an all-India vision.&#x20;
* **Clear contact block** (email, site, phone are visible).&#x20;

# What’s unclear or potentially problematic

* **No pricing, no “what’s included.”** “M.R.P. 50%” is a dramatic claim but lacks: price basis (carpet vs. super built-up), inclusions, taxes, statutory charges, or terms that unlock the 50%.&#x20;
* **Financing copy is contradictory.** The leaflet simultaneously mentions **0%/100%**, multi-tenor **60/120/240 months**, **24–30 months**, and two different dates (**31-12-2025** and **31-12-2030**). It’s not stated whether these are payment plans, possession windows, or scheme deadlines. &#x20;
* **No project addresses or RERA details.** For real-estate marketing in India, state-wise **RERA registration numbers**, exact **project site addresses**, **approvals**, and **developer entity legal names** are typically required. None appear in the leaflet. (Risk: non-compliant advertising; buyers can’t verify.)
* **Overdense layout; readability suffers.** The single page overflows with district lists, repeated unit labels, and Gujarati paragraphs; critical information (price, location, delivery, specs) is buried. &#x20;
* **Specs not defined.** “540/720” likely super built-up; no **carpet area**, no **floorplans**, **FAR**, **amenities**, **parking**, **elevators**, **materials**, or **quality standards**.&#x20;
* **Community math needs context.** The “32 × 8 = 256; ×4 = 1,024 homes” graphic text doesn’t say whether this is a block, sector, or a full township phase, or if it repeats per city.&#x20;

# Potential risks to watch (from a buyer/regulatory lens)

* **Verify legality before any payment.** Ask for **state-specific RERA registration**, **title documents**, **sanctioned plans**, **commencement certificate**, **phase details**, and **construction schedule**.
* **Demand precise commercial terms.** Written **price sheet**, **all-inclusive breakup**, clear **installment schedule** (if 60/120/240 months is offered), **interest/penalties**, **cancellation/refund policy**, **possession/compensation clauses**, and **defect liability**.&#x20;
* **Different dates = different obligations.** The appearance of **31-12-2025** and **31-12-2030** with “24–30 months” could be misunderstood; insist on a signed annexure that defines each date’s meaning. &#x20;

# Suggested improvements (content)

1. **Add a “Project Facts” panel per city**: exact **location**, **RERA no.**, **carpet/super built-up areas**, **amenities**, **specs**, **possession quarter**.
2. **Pricing clarity**: Replace “M.R.P. 50%” with a transparent **rate card** and **offer terms**, including taxes and statutory fees.&#x20;
3. **Payment plan table**: Define tenure options (e.g., **60/120/240 months**), down payment, interest/subvention (if any), and milestone triggers; reconcile the **31-12-2025** and **31-12-2030** references. &#x20;
4. **Separate national footprint from the ad**: Move the district megalist to a back page/appendix; keep the front clear for the offer, USP, visuals, and compliance.&#x20;
5. **Add visuals & proof**: typical **floorplans** (2BHK 540 / 3BHK 720), **site photos**, **approvals**, **sample agreement** excerpts.&#x20;

# Suggested improvements (design & readability)

* Break into a **multi-page brochure** (About → Offer → Locations → Payment → Legal → Contact).
* Use consistent typography; avoid repeating “2 BHK/3 BHK” as decorative elements.&#x20;
* Keep one **hero contact block** (email/site/phone) and one **CTA** (“Book a site visit / Request price sheet”).&#x20;

# Quick takeaway

The leaflet is **ambitious** (800 cities; nationwide district lists) and **simple** on unit types, but it’s **missing critical, verifiable details**: pricing mechanics, precise timelines, regulatory identifiers, and city-wise project facts. Before relying on any offer like “M.R.P. 50%,” or paying based on “60/120/240 months,” request the **formal price sheet, RERA numbers, and signed terms** clarifying the **31-12-2025** vs **31-12-2030** dates.   &#x20;
